...
root = Tk()
root.title('My Utube Downloader')
root.geometry('800x300')
root.resizable(0,0)
root.config(bg='skyblue')

# Heading label
Label(root, text='My Youtube Video Downloader', font=("Comic Sans MS", 15), bg='pink').place(relx=0.25, rely=0.0)

# Creating the main window
Label(root, text='Enter the Youtube link:', font=("Times New Roman", 13), bg='pink').place(relx=0.05, rely=0.2)
...
Label(root, text='Enter the save location:', font=("Times New Roman", 13), bg='pink').place(relx=0.05, rely=0.4)
...
Label(root, text='Enter the filename:', font=("Times New Roman", 13), bg='pink').place(relx=0.05, rely=0.6)
...
download_btn = Button(root, text='Download', font=7, bg='lightgreen',
                      command=lambda: downloader(link_entry, dir_entry, filename_entry)).place(relx=0.3, rely=0.75)

reset_btn = Button(root, text='Reset', font=7, bg='lightgreen',
